...
@class SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedGithubRepo, SharedGithubRepoEntity, SharedGithubRepoMapper, SharedBaseViewModel<T>, SharedDetailsViewModelViewState, SharedGithubRepoManager, SharedDispatcherProvider, SharedMainViewModelViewState, SharedKotlinx_coroutines_coreMainCoroutineDispatcher, SharedKotlinx_coroutines_coreDispatchers, SharedKotlinAbstractCoroutineContextElement, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinUnit, SharedKtor_client_coreTypeInfo, SharedKtor_httpOutgoingContent, SharedKtor_httpContentType, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreHttpClient, SharedKtor_client_coreHttpClientEngineConfig, SharedKotlinx_serialization_runtimeSerialModule, SharedKotlinx_serialization_runtimeSerialKind, SharedKotlinNothing, SharedKotlinx_serialization_runtimeUpdateMode, SharedKtor_ioMemory, SharedKtor_ioByteOrder, SharedKtor_utilsAttributeKey<T>, SharedKtor_httpHttpStatusCode, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKtor_client_coreProxyConfig, SharedKotlinEnum<E>, SharedKotlinKTypeProjection, SharedKtor_httpURLProtocol, SharedKotlinx_coroutines_coreCancellationException, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHeadersBuilder, SharedKtor_httpURLBuilder, SharedKtor_client_coreHttpResponse, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpResponseContainer, SharedKotlinKVariance, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_corePrepareOp, SharedKtor_ioIoBuffer, SharedKotlinByteArray, SharedKtor_ioByteReadPacket, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLinkedListNode, SharedKotlinx_coroutines_coreAbstractAtomicDesc, SharedKtor_ioBuffer, SharedKtor_ioChunkBuffer, SharedKotlinCharArray, SharedKotlinByteIterator, SharedKtor_ioAbstractInput, SharedKtor_ioByteReadPacketBase, SharedKtor_ioByteReadPacketPlatformBase, SharedKotlinCharIterator;

@protocol SharedKotlinx_serialization_runtimeKSerializer, SharedGithubService, SharedLifecycleReceiver, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreCoroutineScope, SharedNavigator, SharedBaseViewState, SharedAnnouncer, SharedKtor_client_jsonJsonSerializer, SharedKtor_client_coreHttpClientEngine, SharedKotlinCoroutineContextKey, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContext, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKotlinx_serialization_runtimeEncoder, SharedKotlinx_serialization_runtimeSerialDescriptor, SharedKotlinx_serialization_runtimeSerializationStrategy, SharedKotlinx_serialization_runtimeDecoder, SharedKotlinx_serialization_runtimeDeserializationStrategy, SharedKotlinx_coroutines_coreFlowCollector, SharedKtor_ioInput, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_ioCloseable, SharedKotlinx_serialization_runtimeCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_runtimeCompositeDecoder, SharedKotlinIterator, SharedKotlinKClass, SharedKtor_client_coreType, SharedKotlinKType, SharedKtor_httpHeaders, SharedKotlinx_coroutines_coreJob, SharedKtor_utilsAttributes, SharedKotlinx_serialization_runtimeSerialModuleCollector, SharedKotlinComparable, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKtor_httpParameters, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_client_coreHttpClientFeature, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpRequest, SharedKotlinSuspendFunction2, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKotlinFunction, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_ioObjectPool, SharedKtor_ioOutput;
...
__attribute__((swift_name("Announcer")))
@protocol SharedAnnouncer
@required
- (void)announceText:(NSString *)text __attribute__((swift_name("announce(text:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DispatcherProvider")))
@interface SharedDispatcherProvider : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) SharedKotlinx_coroutines_coreCoroutineDispatcher *background __attribute__((swift_name("background")));
@property (readonly) SharedKotlinx_coroutines_coreCoroutineDispatcher *main __attribute__((swift_name("main")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepo")))
@interface SharedGithubRepo : SharedBase
- (instancetype)initWithId:(int32_t)id name:(NSString *)name url:(NSString *)url __attribute__((swift_name("init(id:name:url:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedGithubRepo *)doCopyId:(int32_t)id name:(NSString *)name url:(NSString *)url __attribute__((swift_name("doCopy(id:name:url:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepo.Companion")))
@interface SharedGithubRepoCompanion : SharedBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepoManager")))
@interface SharedGithubRepoManager : SharedBase
- (instancetype)initWithGithubService:(id<SharedGithubService>)githubService __attribute__((swift_name("init(githubService:)"))) __attribute__((objc_designated_initializer));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchSortedReposUserName:(NSString *)userName completionHandler:(void (^)(NSArray<SharedGithubRepo *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchSortedRepos(userName:completionHandler:)")));
@end;

__attribute__((swift_name("GithubService")))
@protocol SharedGithubService
@required
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchCodeReposUsername:(NSString *)username completionHandler:(void (^)(NSArray<SharedGithubRepo *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchCodeRepos(username:completionHandler:)")));
@end;

__attribute__((swift_name("Navigator")))
@protocol SharedNavigator
@required
- (void)goToDetailsGithubRepo:(SharedGithubRepo *)githubRepo __attribute__((swift_name("goToDetails(githubRepo:)")));
- (void)goToUrlUrl:(NSString *)url __attribute__((swift_name("goToUrl(url:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepoEntity")))
@interface SharedGithubRepoEntity : SharedBase
- (instancetype)initWithId:(int32_t)id name:(NSString *)name url:(NSString *)url __attribute__((swift_name("init(id:name:url:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedGithubRepoEntity *)doCopyId:(int32_t)id name:(NSString *)name url:(NSString *)url __attribute__((swift_name("doCopy(id:name:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepoEntity.Companion")))
@interface SharedGithubRepoEntityCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubRepoMapper")))
@interface SharedGithubRepoMapper : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSArray<SharedGithubRepo *> *)mapGitApiEntities:(NSArray<SharedGithubRepoEntity *> *)gitApiEntities __attribute__((swift_name("map(gitApiEntities:)")));
- (SharedGithubRepo *)map:(SharedGithubRepoEntity *)receiver __attribute__((swift_name("map(_:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubServiceImpl")))
@interface SharedGithubServiceImpl : SharedBase <SharedGithubService>
- (instancetype)initWithGithubRepoMapper:(SharedGithubRepoMapper *)githubRepoMapper __attribute__((swift_name("init(githubRepoMapper:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("LifecycleReceiver")))
@protocol SharedLifecycleReceiver
@required
- (void)onAttach __attribute__((swift_name("onAttach()")));
- (void)onDetach __attribute__((swift_name("onDetach()")));
@end;

__attribute__((swift_name("BaseViewModel")))
@interface SharedBaseViewModel<T> : SharedBase <SharedLifecycleReceiver>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)emitViewState:(T)viewState __attribute__((swift_name("emit(viewState:)")));
- (void)onAttach __attribute__((swift_name("onAttach()")));
- (void)onDetach __attribute__((swift_name("onDetach()")));
- (id<SharedKotlinx_coroutines_coreFlow>)viewStateStream __attribute__((swift_name("viewStateStream()")));
@property id<SharedKotlinx_coroutines_coreCoroutineScope> coroutineScope __attribute__((swift_name("coroutineScope")));
@property T lastViewState __attribute__((swift_name("lastViewState")));
@end;
...
@interface SharedDetailsViewModel : SharedBaseViewModel<SharedDetailsViewModelViewState *>
- (instancetype)initWithNavigator:(id<SharedNavigator>)navigator __attribute__((swift_name("init(navigator:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)doInitDataGithubRepo:(SharedGithubRepo *)githubRepo __attribute__((swift_name("doInitData(githubRepo:)")));
- (void)onGoToRepositoryClicked __attribute__((swift_name("onGoToRepositoryClicked()")));
@property SharedDetailsViewModelViewState *lastViewState __attribute__((swift_name("lastViewState")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DetailsViewModel.ViewState")))
@interface SharedDetailsViewModelViewState : SharedBase <SharedBaseViewState>
- (instancetype)initWithToolbarTitle:(NSString *)toolbarTitle urlAddress:(NSString *)urlAddress __attribute__((swift_name("init(toolbarTitle:urlAddress:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedDetailsViewModelViewState *)doCopyToolbarTitle:(NSString *)toolbarTitle urlAddress:(NSString *)urlAddress __attribute__((swift_name("doCopy(toolbarTitle:urlAddress:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *toolbarTitle __attribute__((swift_name("toolbarTitle")));
@property (readonly) NSString *urlAddress __attribute__((swift_name("urlAddress")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainViewModel")))
@interface SharedMainViewModel : SharedBaseViewModel<SharedMainViewModelViewState *>
- (instancetype)initWithGithubRepoManager:(SharedGithubRepoManager *)githubRepoManager navigator:(id<SharedNavigator>)navigator announcer:(id<SharedAnnouncer>)announcer dispatcherProvider:(SharedDispatcherProvider *)dispatcherProvider __attribute__((swift_name("init(githubRepoManager:navigator:announcer:dispatcherProvider:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)loadResults __attribute__((swift_name("loadResults()")));
- (void)repoClickedGithubRepo:(SharedGithubRepo *)githubRepo __attribute__((swift_name("repoClicked(githubRepo:)")));
@property SharedMainViewModelViewState *lastViewState __attribute__((swift_name("lastViewState")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainViewModel.ViewState")))
@interface SharedMainViewModelViewState : SharedBase <SharedBaseViewState>
- (instancetype)initWithLoadingIsVisible:(BOOL)loadingIsVisible results:(NSArray<SharedGithubRepo *> *)results __attribute__((swift_name("init(loadingIsVisible:results:)"))) __attribute__((objc_designated_initializer));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedGithubRepo *> *)component2 __attribute__((swift_name("component2()")));
- (SharedMainViewModelViewState *)doCopyLoadingIsVisible:(BOOL)loadingIsVisible results:(NSArray<SharedGithubRepo *> *)results __attribute__((swift_name("doCopy(loadingIsVisible:results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL loadingIsVisible __attribute__((swift_name("loadingIsVisible")));
@property (readonly) NSArray<SharedGithubRepo *> *results __attribute__((swift_name("results")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_coroutines_coreDispatchers")))
@interface SharedKotlinx_coroutines_coreDispatchers : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)dispatchers __attribute__((swift_name("init()")));
@property (readonly) SharedKotlinx_coroutines_coreCoroutineDispatcher *Default __attribute__((swift_name("Default")));
@property (readonly) SharedKotlinx_coroutines_coreMainCoroutineDispatcher *Main __attribute__((swift_name("Main")));
@property (readonly) SharedKotlinx_coroutines_coreCoroutineDispatcher *Unconfined __attribute__((swift_name("Unconfined")));
@end;

@interface SharedKotlinx_coroutines_coreDispatchers (Extensions)
@property (readonly) SharedKotlinx_coroutines_coreCoroutineDispatcher *IO __attribute__((swift_name("IO")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfigKt")))
@interface SharedConfigKt : SharedBase
@property (class, readonly) NSString *GITHUB_BASE_URL __attribute__((swift_name("GITHUB_BASE_URL")));
@property (class, readonly) id<SharedKtor_client_jsonJsonSerializer> ktorSerializer __attribute__((swift_name("ktorSerializer")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpClientEngineKt")))
@interface SharedHttpClientEngineKt : SharedBase
@property (class, readonly) id<SharedKtor_client_coreHttpClientEngine> httpClientEngine __attribute__((swift_name("httpClientEngine")));
@end;
...
@protocol SharedKtor_client_jsonJsonSerializer
@required
- (id)readType:(SharedKtor_client_coreTypeInfo *)type body:(id<SharedKtor_ioInput>)body __attribute__((swift_name("read(type:body:)")));
- (SharedKtor_httpOutgoingContent *)writeData:(id)data __attribute__((swift_name("write(data:)")));
- (SharedKtor_httpOutgoingContent *)writeData:(id)data contentType:(SharedKtor_httpContentType *)contentType __attribute__((swift_name("write(data:contentType:)")));
@end;
...
@required
- (id<SharedKotlinx_serialization_runtimeCompositeEncoder>)beginCollectionDescriptor:(id<SharedKotlinx_serialization_runtimeSerialDescriptor>)descriptor collectionSize:(int32_t)collectionSize __attribute__((swift_name("beginCollection(descriptor:collectionSize:)")));
...
- (id<SharedKotlinx_serialization_runtimeCompositeEncoder>)beginStructureDescriptor:(id<SharedKotlinx_serialization_runtimeSerialDescriptor>)descriptor __attribute__((swift_name("beginStructure(descriptor:)")));
...
@property (readonly) SharedKotlinx_serialization_runtimeSerialModule *context __attribute__((swift_name("context")));
@end;
...
@required
- (id<SharedKotlinx_serialization_runtimeCompositeDecoder>)beginStructureDescriptor:(id<SharedKotlinx_serialization_runtimeSerialDescriptor>)descriptor __attribute__((swift_name("beginStructure(descriptor:)")));
- (id<SharedKotlinx_serialization_runtimeCompositeDecoder>)beginStructureDescriptor:(id<SharedKotlinx_serialization_runtimeSerialDescriptor>)descriptor typeParams:(SharedKotlinArray<id<SharedKotlinx_serialization_runtimeKSerializer>> *)typeParams __attribute__((swift_name("beginStructure(descriptor:typeParams:)"))) __attribute__((unavailable("Parameter typeSerializers is deprecated for removal. Please migrate to beginStructure method with one argument.")));
...
- (id _Nullable)updateNullableSerializableValueDeserializer:(id<SharedKotlinx_serialization_runtimeDeserializationStrategy>)deserializer old:(id _Nullable)old __attribute__((swift_name("updateNullableSerializableValue(deserializer:old:)"))) __attribute__((unavailable("Update* methods are deprecated for removal. Update behaviour is now considered an implementation detail of the format.Updating elements that are outside of structure is an unsupported operation.")));
- (id _Nullable)updateSerializableValueDeserializer:(id<SharedKotlinx_serialization_runtimeDeserializationStrategy>)deserializer old:(id _Nullable)old __attribute__((swift_name("updateSerializableValue(deserializer:old:)"))) __attribute__((unavailable("Update* methods are deprecated for removal. Update behaviour is now considered an implementation detail of the format.Updating elements that are outside of structure is an unsupported operation.")));
@property (readonly) SharedKotlinx_serialization_runtimeSerialModule *context __attribute__((swift_name("context")));
@property (readonly) SharedKotlinx_serialization_runtimeUpdateMode *updateMode __attribute__((swift_name("updateMode"))) __attribute__((unavailable("Update mode in Decoder is deprecated for removal. Update behaviour is now considered an implementation detail of the format that should not concern serializer.")));
@end;
...
@interface SharedKotlinx_serialization_runtimeSerialModule : SharedBase
...
- (id<SharedKotlinx_serialization_runtimeSerializationStrategy> _Nullable)getPolymorphicBaseClass:(id<SharedKotlinKClass>)baseClass value:(id)value __attribute__((swift_name("getPolymorphic(baseClass:value:)")));
- (id<SharedKotlinx_serialization_runtimeDeserializationStrategy> _Nullable)getPolymorphicBaseClass:(id<SharedKotlinKClass>)baseClass serializedClassName:(NSString *)serializedClassName __attribute__((swift_name("getPolymorphic(baseClass:serializedClassName:)")));
@end;
...
- (id _Nullable)decodeSerializableElementDescriptor:(id<SharedKotlinx_serialization_runtimeSerialDescriptor>)descriptor i:(int32_t)i deserializer:(id<SharedKotlinx_serialization_runtimeDeserializationStrategy>)deserializer __attribute__((swift_name("decodeSerializableElement(descriptor:i:deserializer:)"))) __attribute__((unavailable("Please migrate to decodeElement method which accepts old value.Feel free to ignore it if your format does not support updates.")));
...
- (void)defaultPolymorphicBaseClass:(id<SharedKotlinKClass>)baseClass defaultSerializerProvider:(id<SharedKotlinx_serialization_runtimeDeserializationStrategy> _Nullable (^)(NSString *))defaultSerializerProvider __attribute__((swift_name("defaultPolymorphic(baseClass:defaultSerializerProvider:)")));
...
- (id _Nullable)trySelectOtherOtherOp:(SharedKotlinx_coroutines_corePrepareOp * _Nullable)otherOp __attribute__((swift_name("trySelectOther(otherOp:)")));
...
@interface SharedKotlinx_coroutines_corePrepareOp : SharedKotlinx_coroutines_coreOpDescriptor
- (instancetype)initWithAffected:(SharedKotlinx_coroutines_coreLinkedListNode *)affected desc:(SharedKotlinx_coroutines_coreAbstractAtomicDesc *)desc atomicOp:(SharedKotlinx_coroutines_coreAtomicOp<id> *)atomicOp __attribute__((swift_name("init(affected:desc:atomicOp:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)finishPrepare __attribute__((swift_name("finishPrepare()")));
- (id _Nullable)performAffected:(id _Nullable)affected __attribute__((swift_name("perform(affected:)")));
@property (readonly) SharedKotlinx_coroutines_coreLinkedListNode *affected __attribute__((swift_name("affected")));
@property (readonly) SharedKotlinx_coroutines_coreAtomicOp<id> *atomicOp __attribute__((swift_name("atomicOp")));
@property (readonly) SharedKotlinx_coroutines_coreAbstractAtomicDesc *desc __attribute__((swift_name("desc")));
@end;
...
@interface SharedKotlinx_coroutines_coreLinkedListNode : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)addLastNode:(SharedKotlinx_coroutines_coreLinkedListNode *)node __attribute__((swift_name("addLast(node:)")));
- (BOOL)addLastIfNode:(SharedKotlinx_coroutines_coreLinkedListNode *)node condition:(SharedBoolean *(^)(void))condition __attribute__((swift_name("addLastIf(node:condition:)")));
- (BOOL)addLastIfPrevNode:(SharedKotlinx_coroutines_coreLinkedListNode *)node predicate:(SharedBoolean *(^)(SharedKotlinx_coroutines_coreLinkedListNode *))predicate __attribute__((swift_name("addLastIfPrev(node:predicate:)")));
- (BOOL)addLastIfPrevAndIfNode:(SharedKotlinx_coroutines_coreLinkedListNode *)node predicate:(SharedBoolean *(^)(SharedKotlinx_coroutines_coreLinkedListNode *))predicate condition:(SharedBoolean *(^)(void))condition __attribute__((swift_name("addLastIfPrevAndIf(node:predicate:condition:)")));
- (BOOL)addOneIfEmptyNode:(SharedKotlinx_coroutines_coreLinkedListNode *)node __attribute__((swift_name("addOneIfEmpty(node:)")));
...
- (SharedKotlinx_coroutines_coreLinkedListNode * _Nullable)removeFirstOrNull __attribute__((swift_name("removeFirstOrNull()")));
@property (readonly) BOOL isRemoved __attribute__((swift_name("isRemoved")));
@property (readonly) SharedKotlinx_coroutines_coreLinkedListNode *nextNode __attribute__((swift_name("nextNode")));
@property (readonly) SharedKotlinx_coroutines_coreLinkedListNode *prevNode __attribute__((swift_name("prevNode")));
@end;

__attribute__((swift_name("Kotlinx_coroutines_coreAbstractAtomicDesc")))
@interface SharedKotlinx_coroutines_coreAbstractAtomicDesc : SharedKotlinx_coroutines_coreAtomicDesc
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)completeOp:(SharedKotlinx_coroutines_coreAtomicOp<id> *)op failure:(id _Nullable)failure __attribute__((swift_name("complete(op:failure:)")));
- (id _Nullable)failureAffected:(SharedKotlinx_coroutines_coreLinkedListNode *)affected __attribute__((swift_name("failure(affected:)")));
- (void)finishOnSuccessAffected:(SharedKotlinx_coroutines_coreLinkedListNode *)affected next:(SharedKotlinx_coroutines_coreLinkedListNode *)next __attribute__((swift_name("finishOnSuccess(affected:next:)")));
- (void)finishPreparePrepareOp:(SharedKotlinx_coroutines_corePrepareOp *)prepareOp __attribute__((swift_name("finishPrepare(prepareOp:)")));
- (void)onComplete __attribute__((swift_name("onComplete()")));
- (id _Nullable)onPreparePrepareOp:(SharedKotlinx_coroutines_corePrepareOp *)prepareOp __attribute__((swift_name("onPrepare(prepareOp:)")));
- (id _Nullable)prepareOp:(SharedKotlinx_coroutines_coreAtomicOp<id> *)op __attribute__((swift_name("prepare(op:)")));
- (BOOL)retryAffected:(SharedKotlinx_coroutines_coreLinkedListNode *)affected next:(id)next __attribute__((swift_name("retry(affected:next:)")));
@property (readonly) SharedKotlinx_coroutines_coreLinkedListNode *affectedNode __attribute__((swift_name("affectedNode")));
@end;
